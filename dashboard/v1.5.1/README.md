...
```bash
dist/tparc-rms-pi-app-2026.06-rev01.20.tar.gz
```

## Install On The Raspberry Pi

1. Copy `dist/tparc-rms-pi-app-2026.06-rev01.20.tar.gz` to the Pi.

2. Extract it:

```bash
tar -xzf tparc-rms-pi-app-2026.06-rev01.20.tar.gz
```
